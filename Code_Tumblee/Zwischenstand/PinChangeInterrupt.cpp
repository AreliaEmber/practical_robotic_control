...
unsigned volatile long Motor::encoder_count_right_a;
...
unsigned volatile long Motor::encoder_count_left_a;
...
void Ultrasonic::Distance_Measure()
{
  ...
  else if (measure_flag == 1)
  {
    ...
    measure_flag = 2;
    // Serial.println(distance_value); - ! sonst Interruptblockade!!!
  }
}
